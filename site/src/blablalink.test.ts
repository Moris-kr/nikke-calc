...
const catalog: CharacterMeta[] = [
  {
    ...
    className: '화력형', manufacturer: '엘리시온', preview: false, image: null, nameCode: 5001,
  },
  {
    name: '앨리스', burstStage: '3', elementCode: '수냉', weaponType: 'SR',
    className: '화력형', manufacturer: '필그림', preview: false, image: null, nameCode: 5002,
  },
  {
    name: '미공개', burstStage: '3', elementCode: '전격', weaponType: 'AR',
    className: '화력형', manufacturer: '테트라', preview: true, image: null, nameCode: 5003,
  },
];
